...
const deleteConsultations = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, {}, "Selected requests deleted successfully."));
});


export { createConsultationRequest, getAllConsultationRequests, replyToConsultation, deleteConsultations };